...
| --- | --- | ---: | :---: | --- |
| `ANA_BIOTIC_GRENADE_COOLDOWN` | `OW2_ANA_BIOTIC_GRENADE_COOLDOWN` | `12` | 是 | `src/modules/prelude/settings.opy:499` |
| `ANA_SLEEP_DART_COOLDOWN_TIME` | `OW2_ANA_SLEEP_DART_COOLDOWN_TIME` | `12` | 是 | `src/modules/prelude/settings.opy:97`, `src/modules/prelude/settings.opy:503` |
| `ANA_ULT_COST` | `OW2_ANA_ULT_COST` | `2300` | 是 | `src/modules/prelude/settings.opy:94`, `src/modules/prelude/settings.opy:501` |
| `ANRAN_DANCING_BLAZE_COOLDOWN` | `OW2_ANRAN_DANCING_BLAZE_COOLDOWN` | `8` | 是 | `src/modules/prelude/settings.opy:184`, `src/modules/prelude/settings.opy:584` |
| `ANRAN_INFERNO_RUSH_COOLDOWN` | `OW2_ANRAN_INFERNO_RUSH_COOLDOWN` | `8` | 是 | `src/modules/prelude/settings.opy:183`, `src/modules/prelude/settings.opy:583` |
...
| `DOOMFIST_AMMO_REGEN` | `OW2_DOOMFIST_AMMO_REGEN` | `0.4` | 是 | `src/modules/prelude/settings.opy:215`, `src/modules/prelude/settings.opy:605` |
| `DOOMFIST_POWER_BLOCK_COOLDOWN` | `OW2_DOOMFIST_POWER_BLOCK_COOLDOWN` | `8` | 是 | `src/modules/prelude/settings.opy:607` |
| `DOOMFIST_SEISMIC_SLAM_COOLDOWN` | `OW2_DOOMFIST_SEISMIC_SLAM_COOLDOWN` | `7.5` | 是 | `src/modules/prelude/settings.opy:610` |
...
| `JUNO_ULT_COST` | `OW2_JUNO_ULT_COST` | `3135` | 是 | `src/modules/prelude/settings.opy:207`, `src/modules/prelude/settings.opy:597` |
...
| `RAMATTRA_NEMESIS_COOLDOWN` | `OW2_RAMATTRA_NEMESIS_COOLDOWN` | `8` | 是 | `src/modules/prelude/settings.opy:150`, `src/modules/prelude/settings.opy:554` |
...
| `VENTURE_ULT_COST` | `OW2_VENTURE_ULT_COST` | `2125` | 是 | `src/modules/prelude/settings.opy:161`, `src/modules/prelude/settings.opy:566` |
| `WIDOWMAKER_ULT_COST` | `OW2_WIDOWMAKER_ULT_COST` | `1400` | 是 | `src/modules/prelude/settings.opy:423`, `src/modules/prelude/settings.opy:817` |
| `WINSTON_BARRIER_COOLDOWN` | `OW2_WINSTON_BARRIER_COOLDOWN` | `13` | 是 | `src/modules/prelude/settings.opy:272`, `src/modules/prelude/settings.opy:660` |
| `WINSTON_JUMP_PACK_COOLDOWN_TIME` | `OW2_WINSTON_JUMP_PACK_COOLDOWN_TIME` | `5` | 是 | `src/modules/prelude/settings.opy:270` |
| `ZARYA_ULT_COST` | `OW2_ZARYA_ULT_COST` | `2500` | 是 | `src/modules/prelude/settings.opy:225`, `src/modules/prelude/settings.opy:618` |
| `ZENYATTA_ULT_COST` | `OW2_ZENYATTA_ULT_COST` | `2500` | 是 | `src/modules/prelude/settings.opy:303`, `src/modules/prelude/settings.opy:697` |
...
| divergent_duplicate | DOMINA | `DOMINA_BARRIER_ARRAY_COOLDOWN` | `src/constants/player_constants.opy:142` | `8` | legacy value differs from OW2_DOMINA_BARRIER_ARRAY_COOLDOWN (14); this may be a target or a stale duplicate |
| divergent_duplicate | DOMINA | `DOMINA_CRYSTAL_CHARGE_COOLDOWN` | `src/constants/player_constants.opy:141` | `6` | legacy value differs from OW2_DOMINA_CRYSTAL_CHARGE_COOLDOWN (8); this may be a target or a stale duplicate |
| divergent_duplicate | DOMINA | `DOMINA_SONIC_REPULSORS_COOLDOWN` | `src/constants/player_constants.opy:143` | `6` | legacy value differs from OW2_DOMINA_SONIC_REPULSORS_COOLDOWN (7); this may be a target or a stale duplicate |
