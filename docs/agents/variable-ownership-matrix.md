...
| LifeweaverBuff | globalvar (slot 57) | prelude/global-vars.opy | heroes/lifeweaver/settings.aram.opy, aram.opy | A | heroes/lifeweaver/settings.aram.opy | G-LIFEWEAVER move setting with slot 57 | none |
