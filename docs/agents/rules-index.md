...
| R-MODULE-MINIMAL-DEPENDENCY-BOUNDARY | docs/agents/minimal-dependency-boundary.md | #r-module-minimal-dependency-boundary | 模块抽取、跨 Main/ARAM 复用或最小 fixture/依赖边界变更 | repo-maintainers |
